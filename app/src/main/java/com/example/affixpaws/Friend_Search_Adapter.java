...
public class Friend_Search_Adapter extends BaseAdapter {
    ...
    public Friend_Search_Adapter(Context applicationContext, int[] profile_pictures_m, String[] user_names, String[] profile_names){
