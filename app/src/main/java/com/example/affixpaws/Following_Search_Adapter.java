...
public class Following_Search_Adapter extends BaseAdapter {
    ...
    public Following_Search_Adapter(Context applicationContext, int[] profile_pictures_m, String[] user_names, String[] profile_names){
